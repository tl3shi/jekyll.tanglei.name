...
不少人用一个另外的结束条件来进行了判断即: $$ |r^2 - v| \leq t $$, 其实这两个条件是不一样的, 这里考察一下候选人是否能够理解这两者的区别. 
...
8. 问: 你们公司还缺人么, 面试会考察哪些点?   
   答: 人一直缺的, 有兴趣或者有问题可以戳我邮箱, 邮箱地址: ==gCl1mLpVGbn5WY0BUa (就是这个地址), 面试考察可能会涉及: CS 基础/Coding/算法/解决问题/项目经验/系统设计等等. 
